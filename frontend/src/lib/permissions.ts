...
export const permissions = {
    ...
    interactionsRead: "interactions:read",
    interactionsCreate: "interactions:create",
    interactionsUpdate: "interactions:update",
    interactionsDelete: "interactions:delete",
    interactionsSummarize: "interactions:summarize",
...
const rolePermissions: Record<UserRole, Set<Permission>> = {
    ...
    [UserRole.PROVIDER]: new Set([
        ...
        permissions.interactionsRead,
        permissions.interactionsCreate,
        permissions.interactionsUpdate,
        permissions.interactionsDelete,
        permissions.interactionsSummarize,
