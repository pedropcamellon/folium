...
async def seed_interactions(session: AsyncSession, patients: list[Patient]) -> list[Interaction]:
    ...
    maria_interactions = [
        ...
        Interaction(
            ...
            interaction_date=datetime(2026, 2, 15, 9, 0, tzinfo=UTC),
    ...
    james_interactions = [
        Interaction(
            ...
            interaction_date=datetime(2026, 3, 5, 11, 0, tzinfo=UTC),
        ...
        Interaction(
            ...
            interaction_date=datetime(2026, 2, 20, 15, 30, tzinfo=UTC),
            ...
            created_by="nurse@folium.com",
        ),
        Interaction(
            patient_id=patients[1].id,
            type="Appointment",
            title="Sports Physical Exam",
            interaction_date=datetime(2026, 1, 10, 10, 0, tzinfo=UTC),
    ...
    luis_interactions = [
        Interaction(
            ...
            interaction_date=datetime(2026, 3, 7, 9, 30, tzinfo=UTC),
        ...
        Interaction(
            ...
            interaction_date=datetime(2026, 3, 1, 8, 15, tzinfo=UTC),
        ...
        Interaction(
            ...
            interaction_date=datetime(2026, 2, 25, 16, 45, tzinfo=UTC),
        ...
        Interaction(
            ...
            interaction_date=datetime(2026, 1, 15, 10, 30, tzinfo=UTC),
